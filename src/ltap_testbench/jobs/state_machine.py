...
ALLOWED_TRANSITIONS: dict[RunState, set[RunState]] = {
    ...
    RunState.PREFLIGHT: {RunState.AWAITING_CONFIRMATION, RunState.VERIFYING_PATHS, RunState.FAILED},
    RunState.AWAITING_CONFIRMATION: {
        RunState.PREPARING_ROUTER,
        RunState.VERIFYING_PATHS,
        RunState.CANCELLED,
    },
    RunState.PREPARING_ROUTER: {RunState.VERIFYING_PATHS, RunState.RESTORING, RunState.FAILED},
    RunState.VERIFYING_PATHS: {RunState.WARMING_UP, RunState.RESTORING, RunState.FAILED},
    RunState.WARMING_UP: {RunState.RUNNING, RunState.RESTORING, RunState.FAILED},
    RunState.RUNNING: {
        RunState.COOLING_DOWN,
        RunState.CANCEL_REQUESTED,
        RunState.RESTORING,
    ...
    RunState.COOLING_DOWN: {RunState.ANALYZING, RunState.RESTORING, RunState.FAILED},
    RunState.ANALYZING: {RunState.GENERATING_REPORT, RunState.RESTORING, RunState.FAILED},
    RunState.GENERATING_REPORT: {RunState.RESTORING, RunState.COMPLETED, RunState.FAILED},
    RunState.RESTORING: {
        RunState.COMPLETED,
        RunState.CANCELLED,
        RunState.FAILED,
