...
2. Add durable state-transition tests for cancellation, failure, and restart recovery.
3. Add fake RouterOS/test-node scenarios for FastTrack enabled, wrong path counters, API timeout, and Ethernet loss.
